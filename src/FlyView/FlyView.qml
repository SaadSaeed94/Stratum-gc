    ...
    Rectangle {
        ...
        GridLayout {
            ...
            Rectangle {
                ...
                color: "#111B2E"; border.color: "#2B3A5C"; border.width: 1
                Column { anchors.centerIn: parent; spacing: 4
                    QGCColoredImage { anchors.horizontalCenter: parent.horizontalCenter; source: "/res/QGCLogoWhite.svg"; width: 20; height: 20; color: "#D6D9E0" }
            ...
            Rectangle {
                ...
                color: "#111B2E"; border.color: "#2B3A5C"; border.width: 1
                Column { anchors.centerIn: parent; spacing: 4
                    QGCColoredImage { anchors.horizontalCenter: parent.horizontalCenter; source: "/res/QGCLogoFull.svg"; width: 20; height: 20; color: "#D6D9E0" }
