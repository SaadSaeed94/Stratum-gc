...
Item {
    ...
    // ---- IMPORTANT: left gutter safe inset (move ToolStrip + MapScale away from edge)
    // Change this value if you want more/less space from left.
    property real   _leftSafeInset:         ScreenTools.defaultFontPixelWidth * 8    // ~ 120px-ish depending on DPI
    ...
    QGCToolInsets {
        ...
        rightEdgeTopInset:      rightToolStrip.visible ? rightToolStrip.rightEdgeTopInset : topRightPanel.rightEdgeTopInset
        rightEdgeCenterInset:   rightToolStrip.visible ? rightToolStrip.rightEdgeCenterInset : topRightPanel.rightEdgeCenterInset
        topEdgeRightInset:      rightToolStrip.visible ? rightToolStrip.topEdgeRightInset : topRightPanel.topEdgeRightInset
    ...
    MapScale {
        ...
        property real topEdgeCenterInset: visible ? (y + height + _toolsMargin) : 0
    }
