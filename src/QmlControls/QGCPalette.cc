...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(buttonBorder, "#9d9d9d", "#17a2b8", "#707070", "#17a2b8")
    DECLARE_QGC_COLOR(buttonText,           "#9d9d9d", "#333333", "#A6A6A6", "#ffffff")
    DECLARE_QGC_COLOR(buttonHighlight, "#e4e4e4", "#17a2b8", "#3a3a3a", "#17a2b8")
    ...
    DECLARE_QGC_COLOR(groupBorder, "#bbbbbb", "#17a2b8", "#707070", "#17a2b8")
    // Colors not affecting by theming
    //                                                      Disabled     Enabled
    DECLARE_QGC_NONTHEMED_COLOR(brandingPurple, "#00B377", "#008F5A")
    DECLARE_QGC_NONTHEMED_COLOR(brandingBlue, "#00e5ff", "#17a2b8")
